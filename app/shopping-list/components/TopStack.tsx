  ...
  return (
    <div className="pb-4 mt-4 sm:mt-6">
      <div className="flex flex-row justify-center items-center gap-3 px-4">
        <PrimaryButton onClick={() => deleteChecked.mutate()} variant="danger" className="inline-flex items-center text-sm sm:text-base">
          <ListX className="mr-1.5 shrink-0" size={18} />
          Delete Checked
        </PrimaryButton>
        <PrimaryButton onClick={() => deleteAll.mutate()} variant="danger" className="inline-flex items-center text-sm sm:text-base">
